...
| `src/app/prompt.rs` + `tool_state.rs`                     | System-prompt composition (preamble/skills/workspace/AGENTS.md), tool enablement                                                                                                              |
...
| `assets/`                                                 | Bundled preambles, `workmode.md`, `skills/`, models, tools, mcp, images                                                                                                                       |
| `~/.crabot/`                                              | User config: `settings.ron`, `models.ron`, `tools.ron`, `mcp.ron`, `preamble/`, `skills/`, `logs/`                                                                                            |
...
| `bash`    | In-process bashkit interpreter (host commands bridged, embedded Python, VFS sandbox, open `curl`/`wget`); falls back to real `bash -c`; default 120 s timeout (clamped ≥ 1000 ms, max configurable); streams live output; refuses detach requests (`&`, `nohup`/`setsid`) with a `process` tool hint |
