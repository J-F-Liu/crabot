...
| `src/llm.rs`                                              | Streaming engine, agent loop, `DialogPhase`, retry/stall handling, cache management                                                                                                          |
...
| `ask`     | Interactive prompt — intercepted by engine, routed to UI via mpsc; live countdown with "Extend +5 min", "None apply", "You decide"                                                                                       |
